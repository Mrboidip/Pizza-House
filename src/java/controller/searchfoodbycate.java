 ...
 * @author Nhat Anh
 */
@WebServlet(name="searchfoodbycate", urlPatterns={"/searchfoodbycate"})
public class searchfoodbycate extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet searchfoodbycate</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet searchfoodbycate at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        List<Food> foods = foodDAO.searchFoodByCategory(text);
